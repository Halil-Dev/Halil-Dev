<h1 align="center">Merhaba, ben Halil Uysal! 👋</h1>
...
### 💫 Hakkımda
- 🎓 **Burdur Mehmet Akif Ersoy Üniversitesi**'nde 2. sınıf Yazılım Mühendisliği öğrencisiyim.
- 🛡️ **Siber Vatan** programı kapsamında siber güvenlik alanında kendimi geliştiriyorum.
- 💻 **Node.js (EJS, MongoDB)** ve **Spring Boot & Next.js** kullanarak full-stack projeler üretiyorum.
- 🎮 Geçmişte Java ve LibGDX ile roguelike oyunlar üzerinde çalıştım.
- 🎯 Hedefim: DevSecOps ve modern web teknolojilerinde uzmanlaşarak özgün projeler üretmek.

---
### 🚧 Üzerinde Çalıştığım Projeler

- 🏫 **Dershane Yönetim Sistemi** – Spring Boot ve Next.js kullanarak geliştirdiğim kapsamlı bir yönetim platformu.
- 🤖 **Social Media Automation** – Google Gemini API kullanarak otomatik video içerik üretim botu.
- 🏢 **Freelance Web Projeleri** – Eğitim kurumları ve farklı sektörler için modern web çözümleri.
- 🧹 **Telegram Group Cleaner** – Telethon kullanarak grupları otomatik yöneten Python scripti.
...
[![WhatsApp](https://img.shields.io/badge/WhatsApp-25D366?logo=whatsapp&logoColor=white)](https://wa.me/905444100368)
